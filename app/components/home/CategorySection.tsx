  ...
  return (
    <div className="group rounded-2xl bg-white transition-all duration-300 border border-slate-200 hover:border-blue-200 hover:shadow-lg overflow-hidden">
      <div className="flex items-stretch gap-4">
        <div className="shrink-0 bg-blue-50 ring-1 ring-blue-100 flex items-center justify-center w-20 md:w-44 md:h-44">
          <Image
            src={imageSrc}
            alt={imageAlt}
            width={56}
        ...
        <div className="flex-1 py-4 md:py-5">
          <h3 className="text-base md:text-2xl font-semibold text-slate-900 leading-snug">
            {title}
          </h3>
