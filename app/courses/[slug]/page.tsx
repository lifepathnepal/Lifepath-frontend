          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl p-6 text-zinc-900 shadow-xl sticky top-24">
                ...
                <button className="w-full py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-colors mb-3">
                  Enroll Now
                </button>
            ...
            <div className="sticky top-20 space-y-2">
              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-zinc-200">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-6 text-sm text-zinc-600 pt-4 border-t border-zinc-200">
                    <div>
